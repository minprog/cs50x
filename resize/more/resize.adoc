...
1. Execute `wget https://github.com/minprog/cs50x/raw/2020/resize/more/resize.zip` to download a (compressed) ZIP file with this problem's distribution.
...
Be sure to consult the "CS50 manual pages":https://man.cs50.io/ if using functions like `fseek`!
...
[source]
----
check50 -l minprog/cs50x/2020/resize/more
----
